      ...
      <div className="w-full flex flex-col md:flex-row mt-10">
        ...
        <div className="w-full mt-5 text-gray-700 gap-5 flex flex-col">
          ...
          <div className="flex flex-row gap-4 w-full">
            ...
            <button onClick={AddToCar} className={`text-sm text-white bg-button rounded-sm hover:bg-amber-600 py-2 px-5 align-center transition-all duration-200 hover:shadow-xl w-full max-w-48`}>Agregar al carrito</button>
          </div>
